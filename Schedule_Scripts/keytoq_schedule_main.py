...
with open(r'\\10.49.0.250\tracab_neu\07_QC\Scripts\Schedule_script\Season24-25\configs\keytoq_creds.json', 'r') as file:
    config = json.load(file)

for comp_id in config['comp_ids']:
    schedule = Schedule(comp_id=comp_id, vendor='keytoq',
