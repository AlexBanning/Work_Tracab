...
from floodlight_old.core.definitions import essential_events_columns, protected_columns
from floodlight_old.core.code import Code


@dataclass
class Events:
    """Event data fragment. Core class of floodlight_old.
    ...
    found in
    :ref:`floodlight_old.core.definitions <definitions target>`.
        ...
        if incorrect_columns:
            for col in incorrect_columns:
                warnings.warn(
                    ...
                    f"floodlight_old.core.definitions). This may lead to unexpected "
    ...
    def column_values_in_range(self, col: str, definitions: Dict[str, Dict]) -> bool:
        ...
        definitions: Dict
            Dictionary (from floodlight_old.core.definitions) containing specifications for
