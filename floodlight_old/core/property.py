...
class TeamProperty(BaseProperty):
    """Fragment of one continuous team property. Core class of floodlight_old.
...
class PlayerProperty(BaseProperty):
    """Fragment of one continuous property per player. Core class of floodlight_old.
...
class DyadicProperty(BaseProperty):
    """Fragment of one continuous property per player dyad. Core class of floodlight_old.
