...
from floodlight_old.core.definitions import essential_teamsheet_columns, protected_columns


@dataclass
class Teamsheet:
    """Teamsheet storing player information. Core class of floodlight_old.
