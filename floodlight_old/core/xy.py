...
from floodlight_old.vis.positions import plot_positions, plot_trajectories


@dataclass
class XY:
    """Spatio-temporal data fragment. Core class of floodlight_old.
    ...
    def plot(
        ...
        **kwargs,
        ...
        kwargs:
            ...
            given default values are used (see floodlight_old.vis.positions).
