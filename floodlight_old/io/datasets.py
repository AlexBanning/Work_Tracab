...
from floodlight_old.io.utils import extract_zip, download_from_url
from floodlight_old.io.statsbomb import (
    read_open_event_data_json,
    read_teamsheets_from_open_event_data_json,
)
from floodlight_old import XY, Pitch, Events, Code
from floodlight_old.core.teamsheet import Teamsheet
from floodlight_old.settings import DATA_DIR
...
class EIGDDataset:
    ...
    Examples
    --------
    >>> from floodlight_old.io.datasets import EIGDDataset
    ...
    def _transform(data: np.ndarray) -> np.ndarray:
        """Transforms spatiotemporal data from EIGD-format to floodlight_old format.
        ...
        data_transformed: np.ndarray
            ...
            All z-coordinates are omitted to match typical floodlight_old format.
        """
...
class ToyDataset:
    ...
    Examples
    --------
    >>> from floodlight_old.io.datasets import ToyDataset
...
class StatsBombOpenDataset:
    ...
    Examples
    --------
    >>> from floodlight_old.io.datasets import StatsBombOpenDataset
    ...
    def get(
        ...
        data_objects: Tuple[Dict[str, Dict[str, Events]], Dict[str, Teamsheet]]
            Tuple of (nested) floodlight_old core objects with shape (events_objects,
            teamsheets).
