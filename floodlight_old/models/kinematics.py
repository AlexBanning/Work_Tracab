...
covered`
    ...
    >>> import numpy as np
    >>> from floodlight_old import XY
    >>> from floodlight_old.models.kinematics import DistanceModel
...
class VelocityModel(BaseModel):
    ...
    >>> import numpy as np
    >>> from floodlight_old import XY
    >>> from floodlight_old.models.kinematics import VelocityModel
...
class AccelerationModel(BaseModel):
    ...
    >>> import numpy as np
    >>> from floodlight_old import XY
    >>> from floodlight_old.models.kinematics import AccelerationModel
