...
from floodlight_old.utils.types import Numeric
from floodlight_old.core.xy import XY
from floodlight_old.core.property import PlayerProperty
from floodlight_old.models.base import BaseModel, requires_fit
from floodlight_old.models.kinematics import VelocityModel, AccelerationModel
...
equivalent_distance`
    ...
    --------
    >>> import numpy as np
    >>> from floodlight_old import XY
    >>> from floodlight_old.models.kinetics import MetabolicPowerModel
    ...
    def fit(
        ...
        difference: {'central', 'forward}, optional
            ...
            See :func:`~floodlight_old.models.kinematics.VelocityModel` for further details.
