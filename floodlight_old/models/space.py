...
from floodlight_old import XY, Pitch, TeamProperty, PlayerProperty
...
class DiscreteVoronoiModel(BaseModel):
    ...
    --------
    >>> import numpy as np
    >>> from floodlight_old import XY, Pitch
    >>> from floodlight_old.models.space import DiscreteVoronoiModel
